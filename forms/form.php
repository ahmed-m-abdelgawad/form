...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    ...
    <datalist id="client_codes">
        <?php // عرض قائمة أكواد العملاء المتاحة
    ...
    <p>اسم العميل:</p>
    <input type="text" name="client_name" value="<?php echo htmlspecialchars($client_name); ?>" readonly>
    <p>كود العميل:</p>
    <input type="text" name="client_code" value="<?php echo htmlspecialchars($client_code); ?>" readonly>
    <p>كود الفرع:</p>
    <input type="text" name="branch_code" value="<?php echo htmlspecialchars($_SESSION[
        "branch_code"
    ]); ?>" readonly>
    <p>إحداثيات الموقع:</p>
